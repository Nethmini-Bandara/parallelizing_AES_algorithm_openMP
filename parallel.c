...
int main(){
    ...
    char filepath[] = "C:/Users/nethm/Downloads/sample.txt";
    ...
    //printf("The string \"%s\" contains %d letters.\n", buffer, charCount1);
    ...
    //printf("The hexadecimal \"%s\" contains %d letters.\n", hex, strlen(hex));

    if (charCount % 32 == 0) {
        printf("The letter count is divisible by 32. Dividing the string into arrays of 32 indexes:\n");
        ...
        printf("The letter count is not divisible by 16. Adding zeros to the end of the string to make it divisible by 16.\n");
        ...
        printf("The new string \"%s\" contains %d letters and is divisible by 16. Dividing the string into arrays of 16 indexes:\n", hex, charCount + numZeros);
